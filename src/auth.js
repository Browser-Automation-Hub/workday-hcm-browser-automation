/**
 * auth.js — Authentication handler for Workday HCM
 * Supports: SSO (Okta / Azure AD), MFA (Okta / Microsoft MFA)
 *
...
const BASE_URL = process.env.WORKDAY_URL || 'https://impl.workday.com/your-tenant/login.htmld';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set WORKDAY_USERNAME and WORKDAY_PASSWORD in .env`);
  }

  console.log('Logging in to Workday HCM...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
