/**
 * basic-login.js — Basic login example for Workday HCM
...
async function main() {
  ...
  try {
    log('Starting Workday HCM automation (Open Source mode)');
    ...
    const result = await login_workday(page, {
    ...
    // const data = await run_report(page, {});
    // log('Data:', data);
